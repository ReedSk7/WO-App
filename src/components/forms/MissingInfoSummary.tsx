...
export function MissingInfoSummary({ items, onChipClick }: MissingInfoSummaryProps) {
  ...
  return (
    <section className="rounded-panel border border-border-subtle bg-surface-light p-4 shadow-sm dark:bg-surface-dark" aria-labelledby="missing-info-summary">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h2 className="text-sm font-semibold" id="missing-info-summary">
